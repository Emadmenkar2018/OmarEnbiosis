...
import './QuestionsControlButtons.css'

const QuestionsControlButtons = ({prevTitle, nextTitle, finishTitle, currentSlide, prev, questionsCount, isDisableNext}) => {
    return (
        <div className='question-control-btns' >
            {currentSlide !== 0 && 
            ...
            {currentSlide !== (questionsCount - 1) ? 
                <button type='submit' disabled={isDisableNext}>
                    {nextTitle}
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                        width="15" height="15"
                        viewBox="0 0 172 172"
