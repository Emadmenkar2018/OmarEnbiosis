...
import './SwipeableViewsControls.css'

const SwipeableViewsControls = ({next, prev}) => {
    return (
        <Fragment>
            <button onClick={prev} className='prev-button'>
                <div className='right-arrow-icon' style={{transform: 'rotate(180deg)'}}>
...
export default SwipeableViewsControls;